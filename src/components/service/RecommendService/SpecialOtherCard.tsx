      ...
      <CardContent className={classes.content}>
        ...
        <FormControl className={classes.minSelect}>
          ...
          >
            ...
            <MenuItem value={2}>청년 지원 사업</MenuItem>
            <MenuItem value={3}>장학금 지원 사업</MenuItem>
          </Select>
        </FormControl>
        <Button
          className={classes.button}
...
export default SpecialOtherCard;
